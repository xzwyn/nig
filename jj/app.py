...
from pdf_processor import extract_structural_elements
...
with st.sidebar:
    ...
    if st.button("Run Evaluation", disabled=st.session_state.processing_started or not (english_pdf and german_pdf)):
        ...
        with st.spinner("Step 1/2: Processing and aligning documents..."):
            ...
            eng_elements = extract_structural_elements(eng_path, language="eng")
            ger_elements = extract_structural_elements(ger_path, language="deu")
