# ==============================================================================
# Step A: Install system dependencies (Tesseract, Poppler)
# ==============================================================================
print("⏳ Installing system dependencies...")
# Using '> /dev/null' to keep the output clean and fast
!apt-get update > /dev/null
!apt-get install -y tesseract-ocr tesseract-ocr-deu tesseract-ocr-eng poppler-utils > /dev/null
print("✅ System dependencies installed.")

# ==============================================================================
# Step B: FIX the Protobuf library conflict and install Python packages
# This is the key fix for the error you encountered.
# ==============================================================================
print("⏳ Installing Python libraries with the correct protobuf version...")
# Force-installing a compatible protobuf version to prevent the 'GetPrototype' error.
!pip install protobuf==3.20.3 --force-reinstall > /dev/null
# Now install the rest of the packages
!pip install "unstructured[pdf,ocr]" sentence-transformers pandas nltk > /dev/null
...
english_pdf_path = '/kaggle/input/data-2022/en_2022.pdf'  # Update with your actual dataset name
german_pdf_path = '/kaggle/input/data-2022/de_2022.pdf'   # Update with your actual dataset name
...
if not os.path.exists(english_pdf_path) or not os.path.exists(german_pdf_path):
    ...
    df.to_csv('/kaggle/working/aligned_financial_sentences_cleaned.csv', index=False)
    print("\nSaved a reviewable CSV file: '/kaggle/working/aligned_financial_sentences_cleaned.csv'")

    # 5. Format the data for fine-tuning and save as a JSONL file
    finetuning_jsonl = format_for_finetuning(aligned_pairs)
    output_filename = '/kaggle/working/financial_translation_dataset.jsonl'
